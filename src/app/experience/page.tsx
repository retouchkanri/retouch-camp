...
const EXPERIENCES = [
  {
    ...
    desc: "お散歩などを通じて、ポニーと心を通わせる時間です。スタッフが接し方を丁寧にご案内するので、馬に触れるのが初めての方やお子様も安心してご参加いただけます。",
    hint: "horserest.jp の放牧写真のような、ゲストがポニーとふれあう様子",
  },
  {
    code: "esayari",
    title: "②餌やり体験",
  ...
  },
  {
    ...
    price: "1,500円（1組あたり）",
    duration: "所要目安：15〜30分",
    desc: "ブラッシングなどのお手入れを通じて、ポニーのお世話を体験できます。スタッフと一緒に、馬との距離がぐっと近づく時間をお過ごしください。",
    hint: "ゲストがスタッフと一緒にポニーをブラッシングしてお手入れする様子",
  },
  {
    code: "photo",
    title: "④馬の写真撮影",
    price: "3,000円（データ一式）",
    duration: "所要目安：20分",
    desc: "馬たちと過ごすご家族・グループの様子を撮影します。撮影データは後日オンラインで納品。特別な一日の思い出をきれいな形で残せます。",
  ...
  },
  {
    ...
    desc: "牧場の空気を感じながら味わうバーベキュー。地元食材を中心にしたセットをご用意し、手ぶらで気軽に楽しんでいただけます。※安全管理上、焚火・直火は禁止しております。",
    hint: "BBQグリルと夕暮れの牧場を背景にしたゲストの食事風景",
  },
  {
    code: "stargazing",
    title: "⑥星空を眺めながらのんびり過ごす時間",
    price: "1,000円（1組あたり／ブランケット・チェア貸出）",
    duration: "夜間いつでも",
    desc: "夜は、街の明かりから離れた静かな牧場で、星空を眺めながらのんびりとお過ごしください。ブランケットとリクライニングチェアをご用意します。馬たちの気配を感じる、ここだけの夜の時間です。",
    hint: "夜のサイトから見上げる星空と、シルエットになった放牧場の馬たち",
  },
];
  ...
  return (
    <>
      <PageHero
        eyebrow="Experience"
        title="お楽しみいただけること"
        description="ポニーとのふれあい、餌やり体験、ポニーのお手入れ体験、馬の写真撮影、バーベキュー、星空を眺めながらのんびり過ごす時間。有料の体験は、ご予約時にオプションとしてお申し込みください。"
      />
